...
if __name__ == '__main__':
    ...
    dockerfile = os.path.join(file_dir, 'Dockerfile_part2_arlieextract')
    ...
    parser.add_argument("--final-image-name", type=str, help="docker image name for the final image", default='si_software_part2_arlieextract')
