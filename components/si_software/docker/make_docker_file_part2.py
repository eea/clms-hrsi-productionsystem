...
if __name__ == '__main__':
    ...
    dockerfile = os.path.join(file_dir, 'Dockerfile_part2')
    ...
    parser.add_argument("--final-image-name", type=str, help="docker image name for the final image", default='si_software_part2')
    ...
    if os.path.isdir(args.csi_root_dir):
        csi_software_copied_filename = 'csi_si_software_part2.tar.gz'
