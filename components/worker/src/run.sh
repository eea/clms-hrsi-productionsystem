...
echo "make sure the docker image for S&I processing is available"
"$here/ensure_docker_image.sh" "$docker_image_for_si_processing"


python3 -c "
import components.worker.python.run_l1c_worker as run_l1c_worker
run_l1c_worker.main($job_id)
"
