...
assert_directory_existence "$here/../../../config"
...
instance_init_package_name=nomad_server_instance_init_${package_tag}
...
log "copy config files needed for instance initialisation"
cp -r "$here/../../../config" "$instance_init_package_name"

log "copy some scripts needed for instance initialisation"
cp -r "$here/../../../common/get_openstack_ec2_credentials.sh" "$instance_init_package_name"
